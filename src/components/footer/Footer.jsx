...
const Footer = () => {
  return (
    <div id="works" className=" mx-auto m-auto h-[300px]  mt-16 sm:h-[250px]">
      <div className=" bg-gradient-to-r from-blue-300 to-blue-200  h-full flex flex-col gap-8 items-center justify-between p-10 sm:p-7">
        <h2 
        data-aos="zoom-out"
        ...
        <div className="sm:text-[12px]">
          | Copyright &copy; <span>Ruturaj </span> All rights reserved
          <a href="#"></a> |
        </div>
      </div>
    </div>
